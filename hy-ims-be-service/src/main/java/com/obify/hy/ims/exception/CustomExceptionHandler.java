...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<MessageResponse> handleRuntimeException(RuntimeException rex){
        MessageResponse mr = new MessageResponse();
        mr.setMessage(rex.getMessage());
        return new ResponseEntity<MessageResponse>(mr, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
